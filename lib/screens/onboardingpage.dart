    ...
    return MaterialApp(
      ...
      home: Scaffold(
        body: OnboardingPagePresenter(pages: [
          OnboardingPageModel(
            title: 'Fast, Effective and Secure',
            description:
                'Enjoy the best  world jobs in the palm of your hands.',
          ...
          OnboardingPageModel(
            title: 'Offer your favourites',
            description: ' favourite job offers  at a leisure time.',
          ...
          OnboardingPageModel(
            title: 'Growing',
            description:
                'We Dont Just Offer You Job Opportunities, We Offer You A  community To Grow',
            imageUrl: 'assets/images/download2.png',
